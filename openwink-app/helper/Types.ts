...
export type ButtonBehaviors = "Default Behavior" | "Left Wink" | "Left Wink x2" | "Left-Right" | "Left-Right x2" | "Right Wink" | "Right Wink x2" | "Right-Left" | "Right-Left x2" | "Both Blink" | "Both Blink x2" | "Left Wave" | "Right Wave" | "Sleepy Eye";
