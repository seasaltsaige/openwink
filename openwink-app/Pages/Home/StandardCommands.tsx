...
export function StandardCommands() {
  ...
  return (
    <SafeAreaView style={theme.tabContainer}>
      ...
      {/* <ScrollView
        contentContainerStyle={[theme.contentContainer, { backgroundColor: "pink", padding: 0, margin: 0, alignItems: "center", justifyContent: "center" }]}
      > */}


      <ScrollView contentContainerStyle={[theme.contentContainer, { rowGap: 12, alignItems: "center", width: "100%" }]}>
        <MiataHeadlights
