...
void BLE::initServiceCharacteristics()
{
    ...
    leftStatusChar =
        winkService->createCharacteristic(LEFT_STATUS_UUID, NIMBLE_PROPERTY::NOTIFY | NIMBLE_PROPERTY::READ);
    rightStatusChar =
        winkService->createCharacteristic(RIGHT_STATUS_UUID, NIMBLE_PROPERTY::NOTIFY | NIMBLE_PROPERTY::READ);
    ...
    customCommandChar = winkService->createCharacteristic(
        CUSTOM_COMMAND_UUID, NIMBLE_PROPERTY::NOTIFY | NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::WRITE);
    ...
    firmwareUpdateNotifier =
        otaService->createCharacteristic(SOFTWARE_UPDATING_CHAR_UUID, NIMBLE_PROPERTY::NOTIFY | NIMBLE_PROPERTY::READ);
    firmwareStatus =
        otaService->createCharacteristic(SOFTWARE_STATUS_CHAR_UUID, NIMBLE_PROPERTY::NOTIFY | NIMBLE_PROPERTY::READ);
    ...
    headlightMotionChar = settingsService->createCharacteristic(HEADLIGHT_MOTION_IN_UUID,
                                                                NIMBLE_PROPERTY::NOTIFY | NIMBLE_PROPERTY::READ);
    sleepSettingsChar = settingsService->createCharacteristic(
        SLEEPY_SETTINGS_UUID, NIMBLE_PROPERTY::WRITE | NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::NOTIFY);
    ...
    clientMacChar = settingsService->createCharacteristic(
        CLIENT_MAC_UUID, NIMBLE_PROPERTY::WRITE | NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::NOTIFY);
